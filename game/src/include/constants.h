...
const std::string LIGHTNING_ICON = "lightning_icon";
...
constexpr float CASTLE_ARROW_DAMAGE = 50.0f;
constexpr float CASTLE_FIREBALL_DAMAGE = 75.0f;

constexpr int WARRIOR_RESPAWN_TIME = 30;
constexpr int FORMATION_RESPAWN_TIME = 20;
constexpr float CASTLE_BOW_ATTACK_TIME = 3;
constexpr float CASTLE_FIREBALL_ATTACK_TIME = 4;

// multipliers

const std::string HERO_HP_M = "hero_hp";                               // done
const std::string HERO_DAMAGE_M = "hero_damage";                       // done
const std::string HERO_ATTACK_SPEED_M = "hero_attack_speed";           // done
const std::string HERO_SPEED_M = "hero_speed";                         // done
const std::string HERO_RESPAWN_TIME_M = "hero_respawn_time";           // done
const std::string HERO_UNIT_HP_M = "hero_unit_hp";                     // done
const std::string HERO_UNIT_DAMAGE_M = "hero_unit_damage";             // done
const std::string HERO_UNIT_ATTACK_SPEED_M = "hero_unit_attack_speed"; // done
const std::string HERO_UNIT_RESPAWN_TIME_M = "hero_unit_respawn_time"; // done
const std::string GOLD_PICKUP_RANGE_M = "gold_pickup_range";
const std::string HOUSE_HP_M = "house_hp";                           // done
const std::string BUILDING_UPGRADE_COST_M = "building_upgrade_cost"; // done
const std::string TRIBUTE_RATE_M = "tribute_rate";                   // done
const std::string CASTLE_ATTACK_RANGE_M = "castle_attack_range";     // done
const std::string CASTLE_ATTACK_SPEED_M = "castle_attack_speed";     // done
const std::string CASTLE_DAMAGE_M = "castle_damage";                 // done
const std::string CASTLE_HP_M = "castle_hp";                         // done
const std::string BARRACKS_HP_M = "barracks_hp";                     // done
const std::string ARCHERY_HP_M = "archery_hp";                       // done
const std::string DEFENSE_TOWER_HP_M = "defense_tower_hp";           // done
const std::string WIZARDRY_HP_M = "wizardry_hp";                     // done
const std::string BARRACKS_PRODUCTION_RATE_M =
    "barracks_production_rate";                                          // done
const std::string ARCHERY_PRODUCTION_RATE_M = "archery_production_rate"; // done
const std::string WIZARDRY_PRODUCTION_RATE_M =
    "wizardry_production_rate";                                          // done
const std::string BARRACKS_UNIT_COST_M = "barracks_unit_cost";           // done
const std::string ARCHERY_UNIT_COST_M = "archery_unit_cost";             // done
const std::string WIZARDRY_UNIT_COST_M = "wizardry_unit_cost";           // done
const std::string DEFENSE_TOWER_RANGE_M = "defense_tower_range";         // done
const std::string INFANTRY_HP_M = "infantry_hp";                         // done
const std::string INFANTRY_DAMAGE_M = "infantry_damage";                 // done
const std::string INFANTRY_ATTACK_SPEED_M = "infantry_attack_speed";     // done
const std::string INFANTRY_MOVEMENT_SPEED_M = "infantry_movement_speed"; // done
const std::string RANGED_UNIT_HP_M = "ranged_unit_hp";                   // done
const std::string RANGED_UNIT_DAMAGE_M = "ranged_unit_damage";           // done
const std::string RANGED_UNIT_ATTACK_SPEED_M =
    "ranged_unit_attack_speed";                                        // done
const std::string RANGED_UNIT_RANGE_M = "ranged_unit_range";           // done
